...
```sh
  cd my-folder
  git clone https://github.com/Al-Amin-Khan-Shakil/hello-rails-react.git
```
...
Feel free to check the [issues page](https://github.com/Al-Amin-Khan-Shakil/hello-rails-react/issues).
...
I would like to thank Jubaer Maruf to help me connect react with rails.
<p align="right">(<a href="#readme-top">back to top</a>)</p>
